...
// abstract class MyAbstractClass implements MyInterface & Person {
//   name: 'ese'
//   age:"ste"
...
// // Класс, наследующий от абстрактного класса и реализующий абстрактный метод
...
// myObj.abstractMethod(); // Выводит "Abstract method implemented"
// myObj.method(); // Выводит "Method implemented"